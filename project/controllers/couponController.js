...
router.delete('/coupons/:cid/delete-used-coupon', async (req, res) => {
    const coupon_id = req.params.cid;
    await appService.deleteCoupon(coupon_id);
});

// retrieve restaurants with good coupon deals
router.get('/coupons/retrieve-good-deal-restaurant', async(req,res) => {
